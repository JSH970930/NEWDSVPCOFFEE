...
public class MemberController {
	...
	@GetMapping("/login/idpwForm")
	public String idpwMember() {
		return "member/login/idpwForm";
	}

	@GetMapping("/login/idpwresultForm")
	public String idpwresultMember() {
		return "member/login/idpwresultForm";
	}
	...
	public String findMember() {
	  ...
	  @GetMapping("/searchid")
	  public String searchid(Model model,@RequestParam(value="personname", required = false) String pm
	  ,@RequestParam(value="email", required = false) String email) {
	  
	  MemberDto memberdto = memberService.findByName(pm);
	  model.addAttribute("memberdto", memberdto); 
